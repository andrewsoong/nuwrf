...
#------------------------------------------------------------------------------
#                                                                              
# SCRIPT:  run_convert_emiss.discover.sh
#                                                                              
# AUTHOR:                                                                      
# Eric Kemp, NASA SSSO/SSAI
#                                                                              
# DESCRIPTION:                                                                 
# Sample batch script for running convert_emiss.exe on NASA GSFC Discover 
...
for domain in `seq 1 $numDomains` ; do
    ...
    ln -s namelist.input.convert_emiss.${d} namelist.input || exit 1
	...
	mpiexec_mpt -n 1 ./convert_emiss.exe || exit 1    	
