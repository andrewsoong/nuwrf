...
!use chem1_list
use grid_dims_out, only:  use_bbem, use_gfedv2, use_gfedv3, use_gfedv4, use_qfed, use_fwbawb ! NUWRF
...
if(spc_name == 'ETE') then
   ...
   if(use_bbem   == 1 .or. use_gfedv2 == 1 .or. use_gfedv3 == 1 .or. use_qfed == 1 ) found_emiss_spc(iespc,bburn)    = 1 ! NUWRF
...
if(spc_name == 'CSL') then
   ...
   if(use_gfedv3 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 108/94*gfedv3_g(ident)%src(:,:,1) ! NUWRF
   if(use_gfedv4 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 108/94*gfedv4_g(ident)%src(:,:,1) ! NUWRF
   if(use_qfed == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 108/94*qfed_g(ident)%src(:,:,1) ! NUWRF
...
if(spc_name == 'TOL') then
   ...
   if(use_gfedv3 == 1) emiss_g(iespc)%src_bburn(:,:,1)   =  92/82*gfedv3_g(benzene	 )%src(:,:,1) + &
   							    gfedv3_g(toluene	 )%src(:,:,1) + &
   							    92/106*gfedv3_g(ethylbenzene)%src(:,:,1) + &
   							    92/104*gfedv3_g(styrene	 )%src(:,:,1) + &
   							    92/164*gfedv3_g(PAH 	 )%src(:,:,1) ! NUWRF

   if(use_gfedv4 == 1) emiss_g(iespc)%src_bburn(:,:,1)   =  92/82*gfedv4_g(benzene	 )%src(:,:,1) + &
   							    gfedv4_g(toluene	 )%src(:,:,1) + &
   							    92/106*gfedv4_g(ethylbenzene)%src(:,:,1) + &
   							    92/104*gfedv4_g(styrene	 )%src(:,:,1) + &
   							    92/164*gfedv4_g(PAH 	 )%src(:,:,1) ! NUWRF

   if(use_qfed == 1) emiss_g(iespc)%src_bburn(:,:,1)   =  92/82*qfed_g(benzene	 )%src(:,:,1) + &
   							    qfed_g(toluene	 )%src(:,:,1) + &
   							    92/106*qfed_g(ethylbenzene)%src(:,:,1) + &
   							    92/104*qfed_g(styrene	 )%src(:,:,1) + &
   							    92/164*qfed_g(PAH 	 )%src(:,:,1) ! NUWRF
...
if(spc_name == 'OLT') then
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = gfedv3_g(C3H6	       )%src(:,:,1) + &
  							42/56*gfedv3_g(butene_1      )%src(:,:,1) + &
  							42/70*gfedv3_g(pentene_1     )%src(:,:,1) + &
   							42/70*gfedv3_g(Butene_2_Me   )%src(:,:,1) + &
   							42/84*gfedv3_g(pentene_4_me_1)%src(:,:,1) + &
  							42/84*gfedv3_g(pentene_2_me_1)%src(:,:,1) + &
 							42/84*gfedv3_g(hexene_1      )%src(:,:,1) + & 
							42/112*gfedv3_g(octenes       )%src(:,:,1) ! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = gfedv4_g(C3H6	       )%src(:,:,1) + &
  							42/56*gfedv4_g(butene_1      )%src(:,:,1) + &
  							42/70*gfedv4_g(pentene_1     )%src(:,:,1) + &
   							42/70*gfedv4_g(Butene_2_Me   )%src(:,:,1) + &
   							42/84*gfedv4_g(pentene_4_me_1)%src(:,:,1) + &
  							42/84*gfedv4_g(pentene_2_me_1)%src(:,:,1) + &
 							42/84*gfedv4_g(hexene_1      )%src(:,:,1) + & 
							42/112*gfedv4_g(octenes       )%src(:,:,1) ! NUWRF

   if(use_qfed== 1) emiss_g(iespc)%src_bburn(:,:,1) = qfed_g(C3H6	       )%src(:,:,1) + &
  							42/56*qfed_g(butene_1      )%src(:,:,1) + &
  							42/70*qfed_g(pentene_1     )%src(:,:,1) + &
   							42/70*qfed_g(Butene_2_Me   )%src(:,:,1) + &
   							42/84*qfed_g(pentene_4_me_1)%src(:,:,1) + &
  							42/84*qfed_g(pentene_2_me_1)%src(:,:,1) + &
 							42/84*qfed_g(hexene_1      )%src(:,:,1) + & 
							42/112*qfed_g(octenes       )%src(:,:,1) ! NUWRF
...
if(spc_name == 'DIEN') then
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = gfedv3_g(butadiene	)%src(:,:,1) + &
  							54/68*gfedv3_g(pentadienes	)%src(:,:,1) + &
  							54/66*gfedv3_g(cyclopentadiene)%src(:,:,1) + &
  							54/82*gfedv3_g(hexadienes	)%src(:,:,1) ! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = gfedv4_g(butadiene	)%src(:,:,1) + &
  							54/68*gfedv4_g(pentadienes	)%src(:,:,1) + &
  							54/66*gfedv4_g(cyclopentadiene)%src(:,:,1) + &
  							54/82*gfedv4_g(hexadienes	)%src(:,:,1) ! NUWRF

   if(use_qfed== 1) emiss_g(iespc)%src_bburn(:,:,1) = qfed_g(butadiene	)%src(:,:,1) + &
  							54/68*qfed_g(pentadienes	)%src(:,:,1) + &
  							54/66*qfed_g(cyclopentadiene)%src(:,:,1) + &
  							54/82*qfed_g(hexadienes	)%src(:,:,1) ! NUWRF
...
if(spc_name == 'HC8') then
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = 114/100*gfedv3_g(heptane      )%src(:,:,1) + &
  							114/74*gfedv3_g(Butanols     )%src(:,:,1) + &
  							114/86*gfedv3_g(cyclopentanol)%src(:,:,1) ! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = 114/100*gfedv4_g(heptane      )%src(:,:,1) + &
  							114/74*gfedv4_g(Butanols     )%src(:,:,1) + &
  							114/86*gfedv4_g(cyclopentanol)%src(:,:,1) ! NUWRF

   if(use_qfed== 1) emiss_g(iespc)%src_bburn(:,:,1) = 114/100*qfed_g(heptane      )%src(:,:,1) + &
  							114/74*qfed_g(Butanols     )%src(:,:,1) + &
  							114/86*qfed_g(cyclopentanol)%src(:,:,1)	! NUWRF
...
if(spc_name == 'OLI') then
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = 68/56*gfedv3_g(butene_tr_2 )%src(:,:,1) + &
  							68/56*gfedv3_g(butene_cis_2)%src(:,:,1) + &
  							68/70*gfedv3_g(pentene_2     )%src(:,:,1) + &
  							gfedv3_g(cyclopentene)%src(:,:,1) + &
  							68/56*gfedv3_g(butene_i    )%src(:,:,1)	! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = 68/56*gfedv4_g(butene_tr_2 )%src(:,:,1) + &
  							68/56*gfedv4_g(butene_cis_2)%src(:,:,1) + &
  							68/70*gfedv4_g(pentene_2     )%src(:,:,1) + &
  							gfedv4_g(cyclopentene)%src(:,:,1) + &
  							68/56*gfedv4_g(butene_i    )%src(:,:,1)	! NUWRF

   if(use_qfed== 1) emiss_g(iespc)%src_bburn(:,:,1) = 68/56*qfed_g(butene_tr_2 )%src(:,:,1) + &
  							68/56*qfed_g(butene_cis_2)%src(:,:,1) + &
  							68/70*qfed_g(pentene_2     )%src(:,:,1) + &
  							qfed_g(cyclopentene)%src(:,:,1) + &
  							68/56*qfed_g(butene_i    )%src(:,:,1) ! NUWRF
...
if(spc_name == 'HC3') then
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = 44/72*gfedv3_g(butane_2_Me)%src(:,:,1) + &
  							gfedv3_g(C3H8	    )%src(:,:,1) + &
  							44/58*gfedv3_g(butane_n   )%src(:,:,1) + &
  							44/58*gfedv3_g(butane_i   )%src(:,:,1) + &
  							44/32*gfedv3_g(Methanol   )%src(:,:,1) + &
 							44/46*gfedv3_g(Ethanol    )%src(:,:,1) + &
  							44/26*gfedv3_g(C2H2	    )%src(:,:,1) ! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = 44/72*gfedv4_g(butane_2_Me)%src(:,:,1) + &
  							gfedv4_g(C3H8	    )%src(:,:,1) + &
  							44/58*gfedv4_g(butane_n   )%src(:,:,1) + &
  							44/58*gfedv4_g(butane_i   )%src(:,:,1) + &
  							44/32*gfedv4_g(Methanol   )%src(:,:,1) + &
 							44/46*gfedv4_g(Ethanol    )%src(:,:,1) + &
  							44/26*gfedv4_g(C2H2	    )%src(:,:,1) ! NUWRF

   if(use_qfed== 1) emiss_g(iespc)%src_bburn(:,:,1) = 44/72*qfed_g(butane_2_Me)%src(:,:,1) + &
  							qfed_g(C3H8	    )%src(:,:,1) + &
  							44/58*qfed_g(butane_n   )%src(:,:,1) + &
  							44/58*qfed_g(butane_i   )%src(:,:,1) + &
  							44/32*qfed_g(Methanol   )%src(:,:,1) + &
 							44/46*qfed_g(Ethanol    )%src(:,:,1) + &
  							44/26*qfed_g(C2H2	    )%src(:,:,1) ! NUWRF
...
if(spc_name == 'HC5') then
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = gfedv3_g(pentane_n )%src(:,:,1) + &
  							72/86*gfedv3_g(hexane_n  )%src(:,:,1) + &
  							72/86*gfedv3_g(isohexanes)%src(:,:,1) + &
  							72/60*gfedv3_g(Propanol_1)%src(:,:,1) + &
  							72/60*gfedv3_g(propanol_2)%src(:,:,1) ! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = gfedv4_g(pentane_n )%src(:,:,1) + &
  							72/86*gfedv4_g(hexane_n  )%src(:,:,1) + &
  							72/86*gfedv4_g(isohexanes)%src(:,:,1) + &
  							72/60*gfedv4_g(Propanol_1)%src(:,:,1) + &
  							72/60*gfedv4_g(propanol_2)%src(:,:,1) ! NUWRF

   if(use_qfed == 1) emiss_g(iespc)%src_bburn(:,:,1) = qfed_g(pentane_n )%src(:,:,1) + &
  							72/86*qfed_g(hexane_n  )%src(:,:,1) + &
  							72/86*qfed_g(isohexanes)%src(:,:,1) + &
  							72/60*qfed_g(Propanol_1)%src(:,:,1) + &
  							72/60*qfed_g(propanol_2)%src(:,:,1) ! NUWRF
