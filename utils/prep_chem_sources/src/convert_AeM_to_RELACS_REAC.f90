...
if(spc_name_dummy == 'ALKE') then
   ...
   iespc=iespc+1
   emiss_spc_name(iespc,bburn)           = spc_name_dummy
   if(use_bbem   == 1) emiss_g(iespc)%src_bburn(:,:,1)   =  0.96*bbbem_g(C2H4)%src(:,:,1)+ &
   ...
   if(use_gfedv3 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.96*gfedv3_g(C2H4)%src(:,:,1)+ &
                                                        1.04*gfedv3_g(butene_tr_2 )%src(:,:,1) + &
                                                        1.04*gfedv3_g(butene_cis_2)%src(:,:,1) + &
                                                        1.04*gfedv3_g(pentene_2     )%src(:,:,1) + &
                                                        0.5*1.04*gfedv3_g(cyclopentene)%src(:,:,1) + &
                                                        0.5*1.04*gfedv3_g(butene_i    )%src(:,:,1) + &
							1.04*gfedv3_g(butadiene	)%src(:,:,1) + &
  							1.04*gfedv3_g(pentadienes	)%src(:,:,1) + &
  							1.04*gfedv3_g(cyclopentadiene)%src(:,:,1) + &
  							1.04*gfedv3_g(hexadienes	)%src(:,:,1) + &
							1.04*gfedv3_g(C3H6	       )%src(:,:,1) + &
  							1.04*gfedv3_g(butene_1      )%src(:,:,1) + &
  							1.04*gfedv3_g(pentene_1     )%src(:,:,1) + &
   							1.04*gfedv3_g(Butene_2_Me   )%src(:,:,1) + &
   							1.04*gfedv3_g(pentene_4_me_1)%src(:,:,1) + &
  							1.04*gfedv3_g(pentene_2_me_1)%src(:,:,1) + &
 							1.04*gfedv3_g(hexene_1      )%src(:,:,1) + & 
							1.04*gfedv3_g(octenes       )%src(:,:,1) ! NUWRF

   if(use_gfedv4 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.96*gfedv4_g(C2H4)%src(:,:,1)+ &
                                                        1.04*gfedv4_g(butene_tr_2 )%src(:,:,1) + &
                                                        1.04*gfedv4_g(butene_cis_2)%src(:,:,1) + &
                                                        1.04*gfedv4_g(pentene_2     )%src(:,:,1) + &
                                                        0.5*1.04*gfedv4_g(cyclopentene)%src(:,:,1) + &
                                                        0.5*1.04*gfedv4_g(butene_i    )%src(:,:,1) + &
							1.04*gfedv4_g(butadiene	)%src(:,:,1) + &
  							1.04*gfedv4_g(pentadienes	)%src(:,:,1) + &
  							1.04*gfedv4_g(cyclopentadiene)%src(:,:,1) + &
  							1.04*gfedv4_g(hexadienes	)%src(:,:,1) + &
							1.04*gfedv4_g(C3H6	       )%src(:,:,1) + &
  							1.04*gfedv4_g(butene_1      )%src(:,:,1) + &
  							1.04*gfedv4_g(pentene_1     )%src(:,:,1) + &
   							1.04*gfedv4_g(Butene_2_Me   )%src(:,:,1) + &
   							1.04*gfedv4_g(pentene_4_me_1)%src(:,:,1) + &
  							1.04*gfedv4_g(pentene_2_me_1)%src(:,:,1) + &
 							1.04*gfedv4_g(hexene_1      )%src(:,:,1) + & 
							1.04*gfedv4_g(octenes       )%src(:,:,1) ! NUWRF

   if(use_qfed == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.96*qfed_g(C2H4)%src(:,:,1)+ &
                                                        1.04*qfed_g(butene_tr_2 )%src(:,:,1) + &
                                                        1.04*qfed_g(butene_cis_2)%src(:,:,1) + &
                                                        1.04*qfed_g(pentene_2     )%src(:,:,1) + &
                                                        0.5*1.04*qfed_g(cyclopentene)%src(:,:,1) + &
                                                        0.5*1.04*qfed_g(butene_i    )%src(:,:,1) + &
							1.04*qfed_g(butadiene	)%src(:,:,1) + &
  							1.04*qfed_g(pentadienes	)%src(:,:,1) + &
  							1.04*qfed_g(cyclopentadiene)%src(:,:,1) + &
  							1.04*qfed_g(hexadienes	)%src(:,:,1) + &
							1.04*qfed_g(C3H6	       )%src(:,:,1) + &
  							1.04*qfed_g(butene_1      )%src(:,:,1) + &
  							1.04*qfed_g(pentene_1     )%src(:,:,1) + &
   							1.04*qfed_g(Butene_2_Me   )%src(:,:,1) + &
   							1.04*qfed_g(pentene_4_me_1)%src(:,:,1) + &
  							1.04*qfed_g(pentene_2_me_1)%src(:,:,1) + &
 							1.04*qfed_g(hexene_1      )%src(:,:,1) + & 
							1.04*qfed_g(octenes       )%src(:,:,1) ! NUWRF
...
if(spc_name_dummy == 'BIO') then
   ...
   iespc=iespc+1
   emiss_spc_name(iespc,bburn)           = spc_name_dummy
   if(use_bbem   == 1) emiss_g(iespc)%src_bburn(:,:,1)   =  bbbem_g(Isoprene)%src(:,:,1) + 0.7*bbbem_g(TERPENES)%src(:,:,1) 
                                                            
   if(use_gfedv2 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = gfedv2_g(Isoprene)%src(:,:,1) + 0.7*gfedv2_g(TERPENES)%src(:,:,1)

   if(use_gfedv3 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = gfedv3_g(Isoprene)%src(:,:,1) + 0.7*gfedv3_g(TERPENES)%src(:,:,1) ! NUWRF
   
   if(use_gfedv4 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = gfedv4_g(Isoprene)%src(:,:,1) + 0.7*gfedv4_g(TERPENES)%src(:,:,1) ! NUWRF

   if(use_qfed == 1) emiss_g(iespc)%src_bburn(:,:,1)   = qfed_g(Isoprene)%src(:,:,1) + 0.7*qfed_g(TERPENES)%src(:,:,1) ! NUWRF
...
if(spc_name_dummy == 'ARO') then
   ...
   if(use_bbem   == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.29*0.87*bbbem_g(benzene	)%src(:,:,1) + &
   ...
   if(use_gfedv3 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.29*0.87*gfedv3_g(benzene	)%src(:,:,1) + &
                                                           0.87*gfedv3_g(toluene	)%src(:,:,1) + &
                                                           0.87*gfedv3_g(ethylbenzene)%src(:,:,1) + &
                                                           0.87*gfedv3_g(styrene	)%src(:,:,1) + &
                                                           0.87*gfedv3_g(PAH 	)%src(:,:,1)  + &
							   1.04*gfedv3_g(xylenes)%src(:,:,1) + &
							   1.04*gfedv3_g(Phenol)%src(:,:,1) ! NUWRF

   if(use_gfedv4 == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.29*0.87*gfedv4_g(benzene	)%src(:,:,1) + &
                                                           0.87*gfedv4_g(toluene	)%src(:,:,1) + &
                                                           0.87*gfedv4_g(ethylbenzene)%src(:,:,1) + &
                                                           0.87*gfedv4_g(styrene	)%src(:,:,1) + &
                                                           0.87*gfedv4_g(PAH 	)%src(:,:,1)  + &
							   1.04*gfedv4_g(xylenes)%src(:,:,1) + &
							   1.04*gfedv4_g(Phenol)%src(:,:,1) ! NUWRF

   if(use_qfed == 1) emiss_g(iespc)%src_bburn(:,:,1)   = 0.29*0.87*qfed_g(benzene	)%src(:,:,1) + &
                                                           0.87*qfed_g(toluene	)%src(:,:,1) + &
                                                           0.87*qfed_g(ethylbenzene)%src(:,:,1) + &
                                                           0.87*qfed_g(styrene	)%src(:,:,1) + &
                                                           0.87*qfed_g(PAH 	)%src(:,:,1)  + &
							   1.04*qfed_g(xylenes)%src(:,:,1) + &
							   1.04*qfed_g(Phenol)%src(:,:,1) ! NUWRF
...
if(spc_name_dummy == 'ALKA') then
   ...
   iespc=iespc+1
   emiss_spc_name(iespc,bburn)           = spc_name_dummy
   if(use_bbem	== 1) emiss_g(iespc)%src_bburn(:,:,1) = 1.58*0.94*bbbem_g(heptane         )%src(:,:,1) + &
   ...
   if(use_gfedv3== 1) emiss_g(iespc)%src_bburn(:,:,1) = 1.58*0.94*gfedv3_g(heptane         )%src(:,:,1) + &
  							1.58*0.91*gfedv3_g(Butanols     )%src(:,:,1) + &
  							1.58*1.01*gfedv3_g(cyclopentanol)%src(:,:,1) + &
							0.77*1.11*gfedv3_g(butane_2_Me)%src(:,:,1) + &
  							0.77*0.57*gfedv3_g(C3H8       )%src(:,:,1) + &
  							0.77*1.11*gfedv3_g(butane_n   )%src(:,:,1) + &
  							0.77*1.11*gfedv3_g(butane_i   )%src(:,:,1) + &
  							0.77*0.49*gfedv3_g(Methanol   )%src(:,:,1) + &
  							0.77*1.37*gfedv3_g(Ethanol    )%src(:,:,1) + &
  							0.77*.41*gfedv3_g(C2H2       )%src(:,:,1) + &
							1.23*0.97*gfedv3_g(pentane_n )%src(:,:,1) + &
  							1.23*0.97*gfedv3_g(hexane_n  )%src(:,:,1) + &
  							1.23*0.97*gfedv3_g(isohexanes)%src(:,:,1) + &
  							1.23*1.07*gfedv3_g(Propanol_1)%src(:,:,1) + &
  							1.23*1.07*gfedv3_g(propanol_2)%src(:,:,1) ! NUWRF

   if(use_gfedv4== 1) emiss_g(iespc)%src_bburn(:,:,1) = 1.58*0.94*gfedv4_g(heptane         )%src(:,:,1) + &
  							1.58*0.91*gfedv4_g(Butanols     )%src(:,:,1) + &
  							1.58*1.01*gfedv4_g(cyclopentanol)%src(:,:,1) + &
							0.77*1.11*gfedv4_g(butane_2_Me)%src(:,:,1) + &
  							0.77*0.57*gfedv4_g(C3H8       )%src(:,:,1) + &
  							0.77*1.11*gfedv4_g(butane_n   )%src(:,:,1) + &
  							0.77*1.11*gfedv4_g(butane_i   )%src(:,:,1) + &
  							0.77*0.49*gfedv4_g(Methanol   )%src(:,:,1) + &
  							0.77*1.37*gfedv4_g(Ethanol    )%src(:,:,1) + &
  							0.77*.41*gfedv4_g(C2H2       )%src(:,:,1) + &
							1.23*0.97*gfedv4_g(pentane_n )%src(:,:,1) + &
  							1.23*0.97*gfedv4_g(hexane_n  )%src(:,:,1) + &
  							1.23*0.97*gfedv4_g(isohexanes)%src(:,:,1) + &
  							1.23*1.07*gfedv4_g(Propanol_1)%src(:,:,1) + &
  							1.23*1.07*gfedv4_g(propanol_2)%src(:,:,1) ! NUWRF

   if(use_qfed== 1) emiss_g(iespc)%src_bburn(:,:,1) = 1.58*0.94*qfed_g(heptane         )%src(:,:,1) + &
  							1.58*0.91*qfed_g(Butanols     )%src(:,:,1) + &
  							1.58*1.01*qfed_g(cyclopentanol)%src(:,:,1) + &
							0.77*1.11*qfed_g(butane_2_Me)%src(:,:,1) + &
  							0.77*0.57*qfed_g(C3H8       )%src(:,:,1) + &
  							0.77*1.11*qfed_g(butane_n   )%src(:,:,1) + &
  							0.77*1.11*qfed_g(butane_i   )%src(:,:,1) + &
  							0.77*0.49*qfed_g(Methanol   )%src(:,:,1) + &
  							0.77*1.37*qfed_g(Ethanol    )%src(:,:,1) + &
  							0.77*.41*qfed_g(C2H2       )%src(:,:,1) + &
							1.23*0.97*qfed_g(pentane_n )%src(:,:,1) + &
  							1.23*0.97*qfed_g(hexane_n  )%src(:,:,1) + &
  							1.23*0.97*qfed_g(isohexanes)%src(:,:,1) + &
  							1.23*1.07*qfed_g(Propanol_1)%src(:,:,1) + &
  							1.23*1.07*qfed_g(propanol_2)%src(:,:,1) ! NUWRF
