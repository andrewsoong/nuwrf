...
contains
  ...
  function createFieldWPS(year,month,day,hour, &
    ...
    if (nx < 1 .or. ny < 1) then
       print*,'FATAL, bad dimensions for slab!'
       print*,'nx = ',nx
       print*,'ny = ',ny
       stop 1
    end if
  ...
  subroutine checkFieldWPS(this)
    ...
    if (this%version /= VERSION_WPS) then
       print*,'FATAL, bad format version number, should be 5 for WPS!'
    ...
    if (this%iproj /= IPROJ_LATLON .and. &
       ...
       print*, 'FATAL, illegal map projection selected for output!'
    ...
    if (this%startloc /= SWCORNER .and. this%startloc /= CENTER) then
       print*,'FATAL, invalid entry for startloc!'
    ...
    if (this%startLat < -90 .or. this%startLat > 90) then
       print*,'FATAL, startLat not physical!'
    ...
    if (this%startLon < -180 .or. this%startLat > 360) then
       print*,'FATAL, startLon not physical!'
    ...
    if (this%iproj == IPROJ_LATLON) then
       if (this%deltaLat < 0) then
          print*,'FATAL, invalid deltaLat value!'
    ...
    if (this%iproj == IPROJ_LATLON .or. &
       ...
       if (this%deltaLon < 0) then
          print*,'FATAL, invalid deltaLon value!'
    ...
    if (this%iproj == IPROJ_MERCATOR .or. &
       ...
       if (this%dx < 0 .or. this%dy < 0) then
          print*,'FATAL, invalid dx, dy value!'
    ...
    if (this%iproj == IPROJ_GAUSSIAN) then
       if (this%nlats < 0) then
          print*,'FATAL, invalid nlats value!'
    ...
    if (this%iproj == IPROJ_LAMBERT_CONFORMAL .or. &
       ...
       if (this%xlonc < -180. .or. this%xlonc > 360.) then
          print*,'FATAL, invalid xlonc value!'
    ...
    if (this%iproj == IPROJ_MERCATOR .or. &
       ...
       if (this%truelat1 < -90. .or. this%truelat1 > 90.) then
          print*,'FATAL, invalid truelat1 value!'
    ...
    if (this%iproj == IPROJ_LAMBERT_CONFORMAL) then
       if (this%truelat2 < -90. .or. this%truelat2 > 90.) then
          print*,'FATAL, invalid truelat2 value!'
    ...
    if (this%earth_radius < 0) then
       print*,'FATAL, invalid value of earth_radius!'
    ...
    if (.not. allocated(this%slab)) then
       print*,'FATAL, this%slab is not allocated!'
       stop 1
    end if
  ...
  subroutine compareGridsFieldWPS(field1,field2)
     ...
     case default
        ...
        print*,'FATAL, invalid map projection for FieldWPS data types!'
  ...
  function checkDateTimeFieldWPS(this,year,month,day,hour) result(match)
     ...
     read(this%hdate,'(I4.4,1X,I2.2,1X,I2.2,1X,I2.2)') year_field, &
          month_field, day_field, hour_field

     match = .true.
     if (year .ne. year_field .or. &
         month .ne. month_field .or. &
         day .ne. day_field .or. &
         hour .ne. hour_field) then
!         print*,'WARNING, date/time mismatch for FieldWPS data type!'
